...
class Orb(pygame.sprite.DirtySprite):
    def __init__(self):
        super(Orb, self).__init__()
        self.display = pygame.display.get_surface()

        orb_sprite = pygame.image.load("data/images/target_frame1.png").convert_alpha()
        self.image = pygame.transform.flip(orb_sprite, True, False)
