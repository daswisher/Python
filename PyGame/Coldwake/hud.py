...
#The HUD component formalizes how game information is displayed
...
class BulletElement(pygame.sprite.DirtySprite):
    def __init__(self, font_manager):
        ...
        #States how many shots the player has left
        self.image = self.font_manager.render("BULLETS: %d" % Hud.player.bullets, True, (244, 129, 11))
...
class FPSElement(pygame.sprite.DirtySprite):
    def __init__(self, font_manager):
        ...
        self.display = pygame.display.get_surface()
        self.font_manager = font_manager
        self.image = self.font_manager.render("FPS: %2.1f" % Hud.timer.get_fps(), True, (244, 129, 11))
...
class ScoreElement(pygame.sprite.DirtySprite):
    def __init__(self, font_manager):
        ...
        self.display = pygame.display.get_surface()
        self.font_manager = font_manager
        self.image = self.font_manager.render("SCORE: %d" % Hud.game.score, True, (244, 129, 11))
...
class ComboElement(pygame.sprite.DirtySprite):
    def __init__(self, bonus):
        ...
        self.display = pygame.display.get_surface()
        self.font_manager = pygame.font.Font("data/fonts/coders_crux.ttf", 28)
        #When the user attains a streak, the player will receive a combo with a value that is displayed by this function
        self.image = self.font_manager.render("COMBO! %d PT. BONUS" % bonus, True, (244, 129, 11))
